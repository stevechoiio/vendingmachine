...
describe("Vending Machine", () => {
  ...
  describe("When user is buying a product,", () => {
    describe("user can't make a purchase", () => {
      it("should give an error message when user inputs invalid itemcode", () => {
    ...
    describe("user can make a purchase, and it ", () => {
  ...
  describe("When admin attemps to restock item", () => {
    describe("admin can't restock, and shouldn't change the quantity", () => {
  ...
  describe("When admin is attempting to restock the item", () => {
    describe("admin incan't restock item because", () => {
    ...
    describe("When restocking item inventory", () => {
  ...
  describe("When admin wants to display the stock of the vending machine", () => {
    it("item, it should print the item stock", () => {
    ...
    it("coin, it should print the coin stock", () => {
